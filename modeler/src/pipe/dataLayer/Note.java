...
public abstract class Note extends PetriNetObject {
   ...
   private boolean isFinalMarkingNote = false;// 是否为终止标识标注,默认为false
   ...
   public Note(int x, int y) {
      ...
      note.setText("");
      note.setFont(new Font(Pipe.LABEL_FONT, Font.BOLD, Pipe.LABEL_DEFAULT_FONT_SIZE));
   ...
   public boolean isFinalMarkingNote() {
      return isFinalMarkingNote;
   }

   public void setFinalMarkingNote(boolean isFinalMarkingNote) {
      this.isFinalMarkingNote = isFinalMarkingNote;
   }
