 ...
 *         Class used in state space and GSPN modules for generation of trees
 *         and arrays
...
public class myNode {
   ...
   public void RecursiveExpansion() throws TreeTooBigException {
      ...
      boolean[] enabledTransitions = tree.dataLayer.getTransitionEnabledStatusArray(markup);
      ...
      for (int i = 0; i < enabledTransitions.length; i++) {
         if (enabledTransitions[i] == true) {
            ...
            children[i] = new myNode(newMarkup, this, tree, depth + 1);
