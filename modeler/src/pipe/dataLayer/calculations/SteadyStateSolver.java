 ...
 * @author Nadeem
 *
 *         This class is always used as a static class. It is used to determine
 *         the
 *         steady state of a general stochastic petri net. The only public
 *         method is
...
public class SteadyStateSolver {
    ...
    */
   private static LinkedList[] createSparseMatrix(File rgfile) throws ImmediateAbortException {
...
/**
 * @author Nadeem
 *         This class is used to create a sparse matrix. It represents each
 *         element in
