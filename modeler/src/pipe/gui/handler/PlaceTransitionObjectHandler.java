...
//                     Place place = (Place) currentObject;
//                     place.setMsgPlace(false);
//                     place.setResPlace(false);
//                     place.repaint();
//                     String placeId = place.getId();
//                     if (CreateGui.getModel().isMsgPlace(placeId)) {
//                        CreateGui.getModel().removeMsgPlace(placeId);
//                     }
//                     if (CreateGui.getModel().isResPlace(placeId)) {
//                        CreateGui.getModel().removeResPlace(placeId);
//                     }
//                  }
                   if (currentObject instanceof Place) {
                   createArc(new InhibitorArc(currentObject), currentObject);
         ...
         case Pipe.INHIBARC:
            ...
            if (createInhibitorArc != null) {
               if (!currentObject.getClass().equals(
                  ...
                  Iterator arcsFrom = createInhibitorArc.getSource().getConnectFromIterator();
            ...
            if (createArc != null) {
               if (currentObject != createArc.getSource()) {
                  ...
                  if (isNewArc == true) {
                     ...
                     Iterator arcsFromTarget = createArc.getTarget().getConnectFromIterator();
                        ...
                        if (anArc.getTarget() == createArc.getSource()) {
                           if (anArc instanceof NormalArc) {
                              ...
                              if (inverse.hasInverse()) {
                                 ...
                                 isNewArc = false;
                                 int weightInverse = inverse.getInverse().getWeight();
                                 undoManager.addNewEdit(
