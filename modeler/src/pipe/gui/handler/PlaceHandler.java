...
import pipe.gui.action.CalMsgPlaceAction;
import pipe.gui.action.CalResPlaceAction;
import pipe.gui.action.SetMsgPlaceAction;
import pipe.gui.action.SetResPlaceAction;
...
public class PlaceHandler 
   ...
   public JPopupMenu getPopup(MouseEvent e) {
      ...
      if (CreateGui.getModel().isMsgPlace(((Place)myObject).getId())) {
        	JMenuItem menuItemRemMsg = new JMenuItem(new CalMsgPlaceAction(contentPane,(Place)myObject));
    	    menuItemRemMsg.setText("Cancel MsgPlace");
    	    popup.insert(menuItemRemMsg, index ++);
    	  }else {
    		JMenuItem menuItemAddMsg = new JMenuItem(new SetMsgPlaceAction(contentPane,(Place)myObject));
    	    menuItemAddMsg.setText("Set MsgPlace");
    	    popup.insert(menuItemAddMsg, index ++);
    	  }
      
      if (CreateGui.getModel().isResPlace(((Place)myObject).getId())) {
      	JMenuItem menuItemRemRes = new JMenuItem(new CalResPlaceAction(contentPane,(Place)myObject));
  	    menuItemRemRes.setText("Cancel ResPlace");
  	    popup.insert(menuItemRemRes, index ++);
  	  }else {
  		JMenuItem menuItemAddRes = new JMenuItem(new SetResPlaceAction(contentPane,(Place)myObject));
  	    menuItemAddRes.setText("Set ResPlace");
  	    popup.insert(menuItemAddRes, index ++);
  	  }
