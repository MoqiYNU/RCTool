...
import pipe.gui.action.CalRoutTranAction;
import pipe.gui.action.SetRoutTranAction;
...
public class TransitionHandler
   ...
   public JPopupMenu getPopup(MouseEvent e) {
      ...
      if (CreateGui.getModel().isRoutTran(((Transition) myObject).getId())) {
         JMenuItem menuItemRemCtrl = new JMenuItem(new CalRoutTranAction(contentPane, (Transition) myObject));
         menuItemRemCtrl.setText("Cancel RoutTran");
         popup.insert(menuItemRemCtrl, index++);
      } else {
         JMenuItem menuItemAddCtrl = new JMenuItem(new SetRoutTranAction(contentPane, (Transition) myObject));
         menuItemAddCtrl.setText("Set RoutTran");
         popup.insert(menuItemAddCtrl, index++);
      }
