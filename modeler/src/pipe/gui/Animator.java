 ...
 *         where an
 *         unexpected behaviour will occur when the firing sequence has been
 *         altered
 *         has been resolved. The problem where animation will freeze halfway
 *         while
...
public class Animator {
    ...
    *         I changed the code to keep the random transition found by the
    *         DataLayer.
    ...
    *         AnimationHandler to make it fire the transition before calling this
    *         method.
    ...
    *         during
    *         backwards and stepping to fix the unexcepted behaviour observed
    *         during
    *         animation playback.
    *         The method is renamed back to fireTransition.
    */
