...
public class CreateGui {
   ...
   public static void init() {
      ...
      appGui = new GuiFrame("Cross-Organization Process Editor");

      Grid.enableGrid();

      appTab = new JTabbedPane(JTabbedPane.TOP);
      ...
      JSplitPane pane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, leftPane, appTab);
