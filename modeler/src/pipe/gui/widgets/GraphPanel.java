...
public class GraphPanel
   ...
   final static double GraphLeft = 0.1;
   final static double GraphRight = 0.9;
   final static double GraphTop = 0.1;
   final static double GraphBottom = 0.9;
   final static double GraphPointSize = 1;
   ...
   private void drawAxis(Graphics2D g2) {
      Line2D.Double xAxis = new Line2D.Double(getTranslated(xMin, 0), getTranslated(xMax, 0));
      Line2D.Double yAxis = new Line2D.Double(getTranslated(0, yMin), getTranslated(0, yMax));
      g2.draw(xAxis);
      g2.draw(yAxis);
