...
/**
 * Class that handles the creation of a new JFrame to display the GraphPanel
 * widget and
 * a save button
 *
...
public class CartesianGraphFrame
      extends JFrame {
   ...
   /**
    * Creates the GraphPanel and initialises with xlist and ylist. Create the save
    * button.
    * 
   ...
   public void constructCartesianGraphFrame(ArrayList<Double> xlist, ArrayList<Double> ylist) {
      ...
      graph = new GraphPanel(xlist, ylist);
      add(graph);
