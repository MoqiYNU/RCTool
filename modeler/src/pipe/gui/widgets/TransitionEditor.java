...
public class TransitionEditor extends javax.swing.JPanel {
	...
	private void immediateTransition() {
		...
		// 显示最小和最大执行时间
		minDelayField.setText("" + transition.getMinDelay());
		maxDelayField.setText("" + transition.getMaxDelay());

		delayLabel.setEnabled(true);
		delayPanel.setEnabled(true);
	...
	private void initComponents() {
		...
		delaySplitLabel = new javax.swing.JLabel();
...
//      });
		...
		minDelayField.setMaximumSize(new java.awt.Dimension(80, 19));
		minDelayField.setMinimumSize(new java.awt.Dimension(80, 19));
		minDelayField.setPreferredSize(new java.awt.Dimension(80, 19));
//      minDelayField.setText("" + transition.getMinDelay());
		delayPanel.add(minDelayField);

		delaySplitLabel.setText("——");
		delayPanel.add(delaySplitLabel);
...
//      priorityTextField.setText("" + transition.getPriority());
//      delayPanel.add(priorityTextField);

		maxDelayField.setMaximumSize(new java.awt.Dimension(80, 19));
		maxDelayField.setMinimumSize(new java.awt.Dimension(80, 19));
		maxDelayField.setPreferredSize(new java.awt.Dimension(80, 19));
//      maxDelayField.setText("" + transition.getMaxDelay());
		delayPanel.add(maxDelayField);

		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 1;
		gridBagConstraints.gridy = 4;
		gridBagConstraints.gridwidth = 3;
		transitionEditorPanel.add(delayPanel, gridBagConstraints);
	...
	private void okButtonHandler(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_okButtonHandler
		...
		if (rateComboBox.getSelectedIndex() > 0) {
			...
			double minDelay = 0;
			try {
				minDelay = Double.parseDouble(minDelayField.getText());
			} catch (NumberFormatException nfe) {
				minDelayField.setBackground(new Color(255, 0, 0));
				minDelayField.addCaretListener(caretListener);
				return;
			} catch (Exception e) {
				System.out.println(":" + e);
			}
			...
			double maxDelay = 0;
			try {
				maxDelay = Double.parseDouble(maxDelayField.getText());
			} catch (NumberFormatException nfe) {
				maxDelayField.setBackground(new Color(255, 0, 0));
				maxDelayField.addCaretListener(caretListener);
				return;
			} catch (Exception e) {
				System.out.println(":" + e);
			}
			...
			transition.setMinDelay(minDelay);
			transition.setMaxDelay(maxDelay);
	...
	private javax.swing.JLabel delaySplitLabel;
