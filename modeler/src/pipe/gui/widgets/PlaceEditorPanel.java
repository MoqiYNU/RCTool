...
public class PlaceEditorPanel
   ...
   private void markingSpinnerStateChanged(javax.swing.event.ChangeEvent evt) {// GEN-FIRST:event_markingSpinnerStateChanged
      ...
      if ((markingComboBox.getSelectedIndex() > 0) &&
            (((MarkingParameter) markingComboBox.getSelectedItem()).getValue() != markingSpinner.getValue())) {
   ...
   private void doOK() {
      ...
      try {
         ...
         JSpinner.NumberEditor numberEditor = ((JSpinner.NumberEditor) capacitySpinner.getEditor());
      ...
      try {
         ...
         JSpinner.NumberEditor numberEditor = ((JSpinner.NumberEditor) markingSpinner.getEditor());
         numberEditor.getTextField().setBackground(new Color(255, 0, 0));
      ...
      if (markingComboBox.getSelectedIndex() > 0) {
         ...
         MarkingParameter parameter = (MarkingParameter) markingComboBox.getSelectedItem();
