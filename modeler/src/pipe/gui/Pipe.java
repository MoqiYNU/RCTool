...
public class Pipe {
   ...
   public static final int PLACE_TRANSITION_HEIGHT = 24;
   ...
   // 数据流线的颜色(紫色)
   public static final Color DATA_FLOW_LINE_COLOR = new Color(138, 43, 226);
   ...
   public static final Color CTRL_FILL_COLOUR = new Color(250, 104, 0);

   // For ArcPath:
   public static final int ARC_CONTROL_POINT_CONSTANT = 2;
   public static final int ARC_PATH_SELECTION_WIDTH = 2;
   public static final int ARC_PATH_PROXIMITY_WIDTH = 2;
   ...
   public static final int RESERVED_BORDER = 8;
   ...
   public static final String ANNOTATION_DEFAULT_FONT = "PingFang SC";
   public static final int ANNOTATION_DEFAULT_FONT_SIZE = 10;

   public static final String LABEL_FONT = "PingFang SC";
   public static final int LABEL_DEFAULT_FONT_SIZE = 9;

   public static final int DEFAULT_OFFSET_X = -5;
   public static final int DEFAULT_OFFSET_Y = 35;

   /** X-Axis Scale Value */
   public static final int DISPLAY_SCALE_FACTORX = 7; // Scale factors for loading other Petri-Nets (not yet
                                                      // implemented)
   /** Y-Axis Scale Value */
   public static final int DISPLAY_SCALE_FACTORY = 7; // Scale factors for loading other Petri-Nets (not yet
                                                      // implemented)
   /** X-Axis Shift Value */
   public static final int DISPLAY_SHIFT_FACTORX = 270; // Scale factors for loading other Petri-Nets (not yet
                                                        // implemented)
   /** Y-Axis Shift Value */
   public static final int DISPLAY_SHIFT_FACTORY = 120; // Scale factors for loading other Petri-Nets (not yet
                                                        // implemented)
