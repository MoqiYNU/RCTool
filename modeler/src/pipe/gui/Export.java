...
public class Export {
   ...
   public static void toPNG(JComponent g, String filename) throws IOException, ImageWriteException {
      ...
      // ÉèÖÃDPIÎª600
      PixelDensity pixelDensity = PixelDensity.createFromPixelsPerInch(600, 600);
      map.put("PIXEL_DENSITY", pixelDensity);
      map.put("FORMAT", "png");

      parser.writeImage(img, new FileOutputStream(filename), map);
