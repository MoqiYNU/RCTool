...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <xsl:template match="labels">
      <xsl:element name="labels">
         ...
         <xsl:attribute name="finalMarings">
   ...
   <xsl:template match="place">
      <xsl:element name="place">
         ...
         <xsl:attribute name="sink">
            <xsl:value-of select="sink"/>
         </xsl:attribute> -->
         <xsl:attribute name="msgPlace">
            <xsl:value-of select="msgPlace"/>
         </xsl:attribute>
         <xsl:attribute name="resPlace">
            <xsl:value-of select="resPlace"/>
         </xsl:attribute>
         <xsl:attribute name="linkPlace">
            <xsl:value-of select="linkPlace"/>
         </xsl:attribute>
         <xsl:attribute name="dataPlace">
